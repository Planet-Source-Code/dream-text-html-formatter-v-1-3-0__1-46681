...
Public Sub BrowseForFolder(StartDir As String)
    ...
    With tBrowseInfo
        ...
        .ulFlags = BIF_RETURNONLYFSDIRS + BIF_STATUSTEXT + BIF_BROWSEINCLUDEFILES
...
Public Sub Main()
    ...
    frmMDI.Show 'load up
    Set DialogContainer = frmMDI.PicBrowse 'container for the Treeview
